...
let typeMap: {[index: string]: any} = {
    ...
    "ICrawlLink": ICrawlLink,
    "IDownloadLink": IDownloadLink,
    "IPlexDownload": IPlexDownload,
    "IPlexDownloadScheduledCrawl": IPlexDownloadScheduledCrawl,
    "IProvider": IProvider,
    "IScheduledCrawl": IScheduledCrawl,
    "MediaSearchRequest": MediaSearchRequest,
    "PaginatedResponseOfICrawlLink": PaginatedResponseOfICrawlLink,
    "ProblemDetails": ProblemDetails,
    "Provider": Provider,
    "RenameCrawlLinkRequest": RenameCrawlLinkRequest,
    "SafeHandle": SafeHandle,
    "SafeHandleZeroOrMinusOneIsInvalid": SafeHandleZeroOrMinusOneIsInvalid,
    "SafeWaitHandle": SafeWaitHandle,
    "ScheduledJob": ScheduledJob,
    "TriggerJobRequest": TriggerJobRequest,
    "WaitHandle": WaitHandle,
    "WaitHandleAllOfHandle": WaitHandleAllOfHandle,
}
